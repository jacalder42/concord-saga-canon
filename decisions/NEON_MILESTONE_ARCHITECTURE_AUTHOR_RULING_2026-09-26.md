...
1. **Lucien / Vienna**
   - Lucien voluntarily returns to Vienna in B04 after Baz's death, during strain with Seraphine.
   - The return is not acceptance of Dominion reassignment.
   - M05 culminates there: Lucien separates chosen structure/care from Dominion obedience.
   - Exact Vienna scenes, duration, and irreversible act remain episode/beat work.

2. **Kade B04**
   - M15 retires as a saga milestone.
   - Kade may exist as a human/audience presence before Tahl's death, but his meaningful MT succession begins after Tahl's death.

3. **Tahl accountability**
   - M37 expands to include the public-correction ethic rather than creating a separate milestone.
   - Tahl learns Baz as a specific person and later demonstrates accountability by correcting a consequential interpretation when evidence changes.

4. **Institutional / faction architecture**
   - M13 and M14 are revised to bounded monitoring/containment and public quieting/control politics.
   - Exact names, jurisdictions and actor assignments remain open where current faction canon is unresolved.
   - M18 survives without Kade as a prerequisite.

5. **Technarc**
   - M17 is revised from “first public meta” to a bounded engineered-control failure/human consequence that breaks presumptive Technarc legitimacy in at least one meaningful theater.
   - Exact manufactured-meta mechanics remain held.

6. **Colorstorm**
   - M19 retires **only as a saga-milestone row**.
   - The B05 New Orleans **Colorstorm survives** as a named recurring local event-condition candidate.
   - Retired claims: “first global” event, emotional bleedthrough as planetary weather, automatic distant causal coupling, mandatory B05-finale status.
   - Preserve Colorstorm in event/place/VFX architecture and later B05 beat development.
   - Colorstorm does not cause or gate Santa Fe.

7. **Caro**
   - M54 added: Caro learns that handoff is not abandonment during a large care/evacuation crisis.
   - Chicago is the preferred theater, reached through an ordinary long-postponed home visit; exact occasion remains open.

8. **Elisabet**
   - M55 added: Elisabet recommends bounded protective action before certainty, explicitly distinguishing known/inferred/falsifiable.
   - Tahl originates the critical Santa Fe VT warning; Elisabet does not supernaturally detect Santa Fe.

9. **Caro / Elisabet**
   - M56 added: they choose their relationship while choosing separate necessary work.
   - Exact romance/heat rung remains relationship architecture.

10. **Seraphine / Lucien**
    - M57 added: after Baz and Lucien's Vienna withdrawal, they choose connection without making either responsible for regulating/containing the other.
    - This is a relationship-state milestone, not a physical Mending prerequisite.

11. **Santa Fe**
    - M38 revised: late-B05 warning becomes credible/actionable; B06 escalates to the rupture where Tahl dies.
    - M38 no longer depends on Colorstorm.
    - Exact physical event card remains open.

12. **Tahl death / echo / message**
    - M20 remains ruled at end B06.
    - M21 and M22 merge: Silence preserves a bounded, non-identifiable Tahl echo; one ruled identifiable flare occurs in B09.
    - M22 retires as a separate row.
    - M39 remains the mortal-message inheritance.
    - M23 is revised: Kade's grief writing, believed private, becomes visible/read and seeds later deliberate stewardship.

## Dependency consequences

- remove M18 <- M15
- remove M23 <- M15
- remove all M19 causal dependencies
- M38 <- M55
- M24 may use M38 as broad historical/material setup, not a claim that Santa Fe physically causes global degradation
- M27/M52/M36 former M22 dependencies -> M21
- M33 <- M05 remains character/thematic, not physical

## Colorstorm safeguard

The retained Colorstorm must pass the same event-card discipline as other physical Resonance candidates:

initial conditions -> medium/coupling -> objective observation -> competing interpretation -> limits -> cost -> residue/evidence.

“Colorstorm” is a public/cultural name, not automatically a Mechanica category.

## Promotion record

Promoted to `grids/milestones_payoffs.csv` on 2026-09-26.  
Derived B04–B09 book contexts regenerated after promotion.
