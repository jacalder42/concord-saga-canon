...
| **Loom details after the spine ruling** (09-26: the 11-28 plan is the spine; B07 = Kade's post + NOLA breaks; B08 = thin-place finding + Kade's complicity; Lacuna split foreshadowed end B07, made at start B08). Follow-up ruled: thin place **Santa Fe**; B07 opens **at the funeral, Lacuna prominent**; B09 escape at **Serpent Mound**. **The factions and others think it leads back to Louisiana (perhaps via the storm-wall opening); the primary protagonists know there are multiple wounds and Honey Island must be repaired last** (ruled 09-26). *Maybe* getting that knowledge unravels Tahl (hypothesis). Open: which wounds and in what order; what pre-Mending "repair" is against Mechanica §34/§35; how the crew has the knowledge. Event cards written (`proposals/B07_FUNERAL_POST_*`, `proposals/B08_SANTA_FE_FINDING_*`). Still open, per the cards: Kade's post content, where NOLA breaks, civic or scar, post/break order; the Santa Fe finding and its cost; how the crew learns "Louisiana"; the form and victims of Kade's complicity | `decisions/LOOM_SPINE_AND_ANCHORS_AUTHOR_RULING_2026-09-26.md`; ledger §96, §97 |
| **Elias cards vs the author** — EliasEBCI's Veil/Neon presence, EliasID's *"pre-Neon"* New Orleans move, and "Lacuna barely registers" contradict the author's own statements; corrections proposed, **not applied**. Also: Elias named in B06 or not; Brightbreak as the Neon Rebellion's splinter or a separate network; Lacuna nudging Kade to post; the attack motive; a "Solace" Choirless leader | `recovery/ELIAS_KADE_LACUNA_SOURCE_RECOVERY_2026-09-26.md` §5–§7; ledger §100 |
